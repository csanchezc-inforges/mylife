...
export const CATS: Record<string, Category> = {
  ...
  business:      { label: 'Empresa',      emoji: '🏢', color: '#14b8a6' },
  gifts:         { label: 'Regalos',      emoji: '🎁', color: '#ec4899' },
  delivery:      { label: 'Comida a domicilio', emoji: '🛵', color: '#f97316' },
  ai:            { label: 'IA',           emoji: '🤖', color: '#8b5cf6' },
